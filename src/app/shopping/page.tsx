              ...
              <div className=" text-slate-300" style={{ fontSize: 10 }}>
                <div className="flex gap-4 mt-4">
                  ...
                  <div>
                    ...
                    Quae cumque tenetur quia incidunt vel dolores aliquam id
                    excepturi facere, perspiciatis earum porro inventore nam.
                    Quia iure esse autem cumque molestiae.
                  </div>
                </div>
                <div className="flex gap-4 mt-4">
                  <Image
        ...
        <div className="mb-4 text-slate-200 opacity-40">
          ...
          <div className="bg-slate-900 p-4 text-sm">
            <div className="uppercase text-lg font-medium">
              ...
              eum tenetur odit sapiente, suscipit id.
            </div>
