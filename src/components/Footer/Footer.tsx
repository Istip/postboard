  ...
  return (
    <>
      {user ? (
        <>
          {notifications && (
            <div className="h-screen pointer-events-auto fixed top-0 w-screen left-0 z-10 bg-stone-950/90" />
          )}
          <FooterHint
          ...
          />
          <footer className="w-screen bg-stone-900 border-stone-800 border-t fixed bottom-0 z-20 px-4 pb-2">
            <div
